...
// const get_header = document.querySelectorAll(".header");

// for(let changed_head of get_header){
//     changed_head.style.color = "red";
// }


// const nodeList = document.querySelectorAll(".header , .content");
// nodeList.forEach(
//     function(el){
